...
//Make dialog visible
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (tf.getText().equals("E_RESIZE") && e.getActionCommand().equals("Übernehmen")) {
        ...
        //  checking ig false Mouse Cursor file names are given ,  if yes sgowing a small alert window .
        // long if , can be avoided with else
        if((!tf.getText().equals("DEFAULT") || !tf.getText().equals("WAIT") || !tf.getText().equals("TEXT") || !tf.getText().equals("W_RESIZE") || !tf.getText().equals("SW_RESIZE")
        || !tf.getText().equals("SW_RESIZE") || !tf.getText().equals("SE_RESIZE") || !tf.getText().equals("NW_RESIZE") || !tf.getText().equals("NE_RESIZE") || !tf.getText().equals("N_RESIZE")
         || !tf.getText().equals("MOVE_CURSOR") || !tf.getText().equals("HAND_CURSOR") || !tf.getText().equals("E_RESIZE") || !tf.getText().equals("CROSSHAIR")  ) && e.getActionCommand().equals("Übernehmen")){
            JOptionPane.showMessageDialog(null, "You Entered a falsh mouse cursor name , try again");
        }
    }
